  ...
  What kind of stuffs composite this subject?
	- In C++,
		- The parts used to define the class are called members.
			- data member
			  id:: 6315c27d-5aa5-4465-a75f-7880db7ad4d1
			- function member
		- Sample code
		  ``` c++
		  class X {
				...
				- Access Control
					- ``` c++
					  private:
					      ...
					      Color fcolor {Color::invisible};     // fill color
					  ```
					- All the [data members](((6315c27d-5aa5-4465-a75f-7880db7ad4d1))) are `private`. Their initialization prefers a [[{} - initialization syntax]] style. For `points`, we don't explicitly initialize it since the [[default constructor]] of `vector` provides an empty element list.
