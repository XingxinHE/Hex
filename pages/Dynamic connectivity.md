# 📝Definition
- The input is a sequence of pairs of integers, where each integer represents an object of some type and we are to interpret the pair $p$ $q$ as meaning $p$ is connected to $q$. We assume that "is connected to" is an [[Function#^ca5f2f6ca58df9b7|equivalence relation]].
...
- To start with, we follow the definition of [[data structure#^8a966e5bc270ebf|data structure and interface]] defined in the MIT classes.
...
- Cost model
    - | algorithm  | initialize | union | find |
      | ---------- | ---------- | ----- | ---- |
      | quick-find | $N$        | $N$   | 1    |
    - Union is too expensive. It takes $N^2$([[Algorithm#The Efficiency Table|quadratic]]) array accesses to process a sequence of $N$ union commands on $N$ objects.
